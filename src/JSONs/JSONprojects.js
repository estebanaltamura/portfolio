export const projectsData = [
...

  {
    ...
    projectDetails: [
      ...
      "Finalmente, se realizó una venta con un costo de adquisición de $17.28 y un retorno sobre la inversión en publicidad (ROAS) de 4.5.",      
      "El proyecto, desarrollado con React, incorpora varias dependencias clave para su funcionamiento, entre las que se incluyen Firestore, SweetAlert2, React-Icons, React-Bootstrap y Lottie-React. La utilización de Firestore permite la persistencia de los datos de los leads, asegurando que la información proporcionada por los usuarios se mantenga segura y accesible.", 
      "Se ha prestado especial atención al rendimiento de la página, garantizando que nunca se muestre contenido parcial o desordenado, lo que asegura una experiencia de usuario óptima en todo momento."
    ],
    technologies: [
      { name: "HTML", iconSrc: "https://i.postimg.cc/kGPKdGc8/HtmlIcon.png" },
      { name: "CSS", iconSrc: "https://i.postimg.cc/3Rvm6mgY/cssIcon.png" },
