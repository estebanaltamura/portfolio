              ...
              media !== undefined && media.map((content, index)=>{
                if(index === 0){
                  return <div key={randomId()} className="carousel-item active">
                            {
                              content[0] === "img" ?
                                <img className={type == "desktop" ? "desktopPreviewImage mainPreviewMedia" : "mobilePreviewImage mainPreviewMedia"} src={media[0][1]} />
                                                :                                                
                                <iframe className={type == "desktop" ? "desktopPreviewImage mainPreviewMedia" : "mobilePreviewImage mainPreviewMedia"} src={media[0][1]} controls autoplay></iframe>
                            }
                          </div>
                }
                              ...
                              {
                              content[0] === "img" ?
                                <img className={type == "desktop" ? "desktopPreviewImage" : "mobilePreviewImage"} src={media[index][1]} />
                                                :
                                <iframe className={type == "desktop" ? "desktopPreviewImage" : "mobilePreviewImage"} src={media[index][1]} controls autoplay></iframe>
                              }
                            </div>
