  ...
  return (
    <div className='welcomeContainer'>
      ...
      <div className='paragraphsContainer'>
        ...
        <p className='welcomeParagraphs'>
          En los últimos años he estado trabajando en una incubadora de negocios
          como referente tecnológico, co-fundé una empresa de venta de
          indumentaria en Argentina con excelente posicionamiento y sólidas
          ventas.
        </p>
        <p className='welcomeParagraphs'>
          También co-fundé una empresa de venta de indumentaria en Estados
          Unidos. En esta última experiencia casi quiebro, pero entendí que esto
          es lo mío, me encanta emprender y el proceso startup en su conjunto.
        </p>
        <p className='welcomeParagraphs'>
